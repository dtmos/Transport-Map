...
(function(w){
    ...
    heatmap.prototype = {
        configure: function(config){
				...
				me.set("numbers", config.numbers || false);
				me.set("inflation", config.inflation || 0);
        },
        resize: function () {
        ...
        colorize: function(x, y, count){
                ...
                var me = this,
                    width = me.get("width"),
					inflation = me.get("inflation"),
                    radiusOut = me.get("radiusOut")*(1 + inflation * count/me.store.max),
        ...
        drawAlpha: function(x, y, count){
                ...
                var me = this,
                    //r1 = me.get("radiusIn"),
                    inflation = me.get("inflation"),
                    r2 = me.get("radiusOut")*(1 + inflation * count/me.store.max),
				...
				if (me.get("numbers")) {
					...
					ctx.fillText(Math.round(count), x, y);
		...
		setopt: function(opt){		
                this.set("numbers", opt.numbers);
				this.set("radiusOut", opt.rout);
				this.set("opacity", opt.opacity);
				this.set("inflation", opt.inflation);
        },
        // dataURL export
        getImageData: function(){
                return this.get("canvas").toDataURL("image/png");
        },
        clear: function(){
            var me = this,
                w = me.get("width"),
